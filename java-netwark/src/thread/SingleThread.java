...
public class SingleThread extends Thread{
	public static void main(String[] args) {
		...
		/**
		 * 주의할 점.
		 * 개발자가 코딩한 아래 run() 메소드를 호출하는 것이 아니라 상속받은 start() 메소드를 호출하고
		 * 이 start()메소드가 아래 구현한 run() 메소드를 호출하는 모양을 이해해야함.
		 */
